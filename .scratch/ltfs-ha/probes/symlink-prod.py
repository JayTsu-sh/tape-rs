...
assert os.environ.get('TAPE_RS_SYMLINK_CREATE') == 'TS1001L08-production-test'
mode = sys.argv[1]
assert mode in ('create', 'verify', 'clean')
root = Path('/home/rocky/tape-rs-symlink-create-prod-20260925/mnt/rc')
assert os.path.ismount(root.parent)
p = root / 'symlink-prod-20260925'
